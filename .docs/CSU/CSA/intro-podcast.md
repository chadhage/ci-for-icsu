...
> **Source:** `.docs/CSU/CSA/intro.md` (Intro to Continuous Improvement — CSA persona)
...
_Source: content conveyed verbatim in substance from the iCSU Smart CI 30-Minute Delivery microsite — Intro to Continuous Improvement (CSA persona)._
