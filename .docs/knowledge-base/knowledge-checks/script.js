...
(function () {
  ...
  function renderSummary(container, correct, total, passingScore) {
    ...
    var back = el("a", { className: "btn btn--secondary", href: window.KC_DATA.sourceFile || "https://github.com/chadhage/smart-tools/blob/main/.docs/knowledge-base/index.md" }, ["Back to topic"]);
