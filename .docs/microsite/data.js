...
"intro": {
  ...
  group: "Foundations",
  duration: "30 min",
  executiveSummary: "Continuous Improvement at Microsoft is the connective tissue between the customer-facing practitioner practice and the engineering groups that build Azure. It shows up as the iCSU CI Community of Practice, the WAF and Advisor feedback loops, the practitioner playbook repositories, and the cross-team rituals that compound learnings across the org. For a practitioner it is both a resource (skilling, playbooks, peers) and a responsibility (contribute the patterns you validate, escalate systemic issues to product groups). Done well, CI@MS turns every customer engagement into both an outcome for that customer and a reusable asset for every practitioner that follows.",
  whatYouGain: [
