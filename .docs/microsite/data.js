...
"intro": {
  ...
  questions: [
    ...
    },
    {
      ...
      correctIndex: 2,
      explanation: "Each published pattern carries the <strong>evidence that it worked</strong>, evolves cycle over cycle, has a named owner, and is written for the next CSA to apply — not as an anecdote."
    },
    {
