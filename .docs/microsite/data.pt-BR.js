/* Smart CI - Conteúdo dos módulos de entrega de 30 minutos (Português do Brasil).
...
"intro": {
  ...
  recap: [
    ...
    "A MC não é um projeto; é um modelo operacional. O sucesso é o cliente conduzindo o ciclo sem o praticante",
  ...
  questions: [
    ...
    {
      prompt: "Qual é o critério de saída do praticante para um engajamento de MC bem-sucedido?",
      options: ["O cliente concluiu três ciclos PDCA.", "Todas as recomendações da avaliação inicial foram implementadas.", "O cliente está conduzindo o ciclo sem o praticante.", "O cliente alcançou a maior melhoria possível."],
      correctIndex: 2,
      explanation: "Sucesso na MC significa que <strong>o cliente conduz a cadência de forma independente</strong>. O praticante orienta o ciclo; o sucesso é quando o cliente é dono dele e o praticante pode sair sem regressão."
    },
    {
  ...
  group: "Fundamentos",
  duration: "30 min",
  executiveSummary: "As certificações Lean e Six Sigma usam a metáfora das faixas das artes marciais — Branca, Amarela, Verde, Preta, Mestre Faixa Preta — para sinalizar a profundidade da capacidade de melhoria contínua, desde conhecer o vocabulário até projetar uma estratégia de MC para toda a organização. Para praticantes, a escada de faixas é útil como roteiro pessoal de capacitação, como credencial reconhecida pelos clientes (especialmente em setores regulados) e como referencial de coaching para as equipes do cliente. O princípio-chave: trate cada faixa como a formalização de uma capacidade que você já deveria estar demonstrando em engajamentos reais — as credenciais seguem o trabalho, não o contrário.",
  whatYouGain: [
  ...
  questions: [
    {
      ...
      options: ["Anos de experiência como praticante.", "A profundidade da capacidade de melhoria contínua, de conhecer o vocabulário a liderar a estratégia de MC de toda a organização.", "Quantos engajamentos com clientes ele fechou no último trimestre.", "Sua avaliação interna de desempenho."],
      correctIndex: 1,
    ...
    {
      prompt: "Como um praticante deve decidir qual faixa buscar em seguida?",
      ...
      correctIndex: 2,
      explanation: "A orientação é <strong>escolher a faixa que formaliza a próxima lacuna</strong> — não a mais alta disponível. Um praticante que nunca conduziu um Kaizen real deveria buscar a Amarela, não a Preta. As credenciais devem seguir o trabalho, não o contrário."
    },
    {
    ...
    },
    {
      ...
      correctIndex: 1,
      explanation: "Um praticante com cinco faixas e nenhum resultado de engajamento validado é <strong>menos eficaz</strong> do que um com Faixa Verde e um histórico de vitórias mensuradas com clientes. A credencial é evidência corroborativa, não um substituto para o trabalho."
    },
    {
  ...
  group: "Fundamentos",
  duration: "30 min",
  executiveSummary: "A Melhoria Contínua na Microsoft é o tecido conectivo entre a prática voltada ao cliente e os grupos de engenharia que constroem o Azure. Ela se manifesta como a Comunidade de Prática de MC do CI, os ciclos de feedback do WAF e do Advisor, os repositórios de playbooks e os rituais entre equipes que acumulam aprendizados por toda a organização. Para um praticante é tanto um recurso (capacitação, playbooks, pares) quanto uma responsabilidade (contribuir com os padrões que você valida, escalar problemas sistêmicos aos grupos de produto). Bem feita, a MC@MS transforma cada engajamento com o cliente tanto em um resultado para aquele cliente quanto em um ativo reutilizável para cada praticante que vier depois.",
  whatYouGain: [
    "Compreender como a MC@MS agrega aprendizados de milhares de praticantes e os realimenta aos grupos de produto do Azure",
    "Aprender a consumir playbooks existentes (WAF, Biblioteca de Playbooks, Azure Advisor) em vez de reinventar padrões de engajamento",
  ...
  explanation: "<p>A MC@MS existe para resolver um problema de escala: um único praticante é dono de um punhado de contas, mas a Microsoft tem milhares de praticantes e dezenas de milhares de clientes. Sem uma prática de MC que agregue aprendizados, cada praticante redescobre os mesmos padrões, cada cliente revive os mesmos incidentes e os grupos de produto não ouvem o sinal com clareza suficiente para corrigir as causas-raiz. A MC@MS é o ciclo de feedback que transforma observações de campo em melhorias de produto.</p><p>O que distingue as estruturas da MC@MS é que elas são <strong>medidas, versionadas, com responsável e reutilizáveis</strong>. Cada padrão publicado carrega a evidência de que funcionou. Os playbooks evoluem ciclo a ciclo; versões antigas são depreciadas, não excluídas. Cada playbook tem um mantenedor nomeado e uma cadência de atualização. Os padrões são escritos para que o próximo praticante os aplique, não como anedotas. As principais superfícies incluem a Comunidade de Prática de MC do CI, o referencial de avaliação WAF, o Azure Advisor e o Defender for Cloud como linhas de base por conta, playbooks versionados de práticas / CSE / FastTrack, o currículo do MS Learn e canais estruturados de escalonamento do campo para o PG (bloqueadores de ACR, análise de assinaturas no ICM).</p><p>O ritmo de participação na comunidade é simples: consumir playbooks existentes antes de projetar um novo engajamento; executar PDCA em trabalho real com o cliente; documentar resultados mensurados; levar padrões à reunião mensal da CoP; deixar os pares revisarem e criticarem; mesclar padrões validados nas bibliotecas compartilhadas. Os praticantes tanto consomem quanto contribuem. Pular qualquer um dos lados quebra o ciclo. Quando a mesma causa-raiz aparece em mais de 3 contas, isso é uma conversa com o PG, não uma solução de contorno de um praticante. Use os canais de bloqueador de ACR ou de assinatura no ICM para escalar sinais sistêmicos de modo que a engenharia possa priorizar correções.</p>",
  ...
  recap: [
    "A MC@MS é o tecido conectivo entre os aprendizados de campo e as prioridades dos grupos de produto — transforma a observação de um praticante em melhoria para toda a organização",
    "Cada praticante consome playbooks existentes (WAF, Biblioteca de Playbooks, orientação do Advisor) antes de iniciar um novo engajamento",
    "Contribua com padrões validados de volta à CoP; deixe os pares revisarem; mescle nas bibliotecas compartilhadas; veja-os se acumular entre milhares de praticantes",
    "Quando a mesma causa-raiz aparece em mais de 3 contas, escale como sinal de campo (bloqueador de ACR ou assinatura no ICM) aos grupos de produto, não como solução de contorno de praticante",
  ...
  questions: [
    {
      ...
      options: ["Substituir planos de engajamento específicos do cliente por um único modelo corporativo.", "Agregar aprendizados entre praticantes e fornecer um ciclo de feedback orientado por dados do campo para os grupos de produto.", "Certificar praticantes nos serviços do Azure.", "Fornecer um sistema centralizado de controle de horas para a prática."],
      correctIndex: 1,
      explanation: "A MC@MS é o tecido conectivo entre o campo e a engenharia. Ela <strong>agrega padrões</strong> para que o PG possa priorizar correções, codifica padrões de engajamento validados em playbooks compartilhados e transforma a observação de um praticante em melhoria em nível de produto."
    },
    {
      prompt: "O que distingue um playbook da MC@MS de um genérico &ldquo;wiki interno de dicas&rdquo;?",
      options: ["Os playbooks só são acessíveis a praticantes sêniores.", "Os playbooks são gerados automaticamente a partir da telemetria do Azure.", "Os playbooks são medidos, versionados, de propriedade de um mantenedor nomeado com cadência de atualização e escritos para serem reutilizáveis.", "Os playbooks são escritos exclusivamente pelos grupos de produto."],
      correctIndex: 2,
      explanation: "Cada padrão publicado carrega a <strong>evidência de que funcionou</strong>, evolui ciclo a ciclo, tem um responsável nomeado e é escrito para que o próximo praticante o aplique — não como anedota."
    },
    {
      prompt: "Um praticante identifica a mesma limitação de produto surgindo em três ou mais de suas contas. O que a MC@MS recomenda que ele faça?",
      ...
      correctIndex: 2,
      explanation: "Quando a mesma causa-raiz aparece em várias contas, isso é uma <strong>conversa com o PG, não uma solução de contorno de praticante</strong>. Os canais de sinal do campo para o PG (rastreador de bloqueadores de ACR, análise de assinaturas no ICM) existem para transformar a evidência agregada em MC em nível de produto."
    },
    {
    ...
    },
    {
      ...
      options: ["Um praticante que escala todo problema diretamente ao PG sem tentar resolvê-lo primeiro.", "Um praticante que apenas consome playbooks, mas nunca contribui de volta.", "Um praticante que valida muitos padrões em suas contas, mas nunca os publica — forçando cada outro praticante a redescobrir as mesmas lições.", "Um praticante que trabalha sem um gestor ou revisor par."],
      correctIndex: 2,
      explanation: "A MC@MS é uma prática de muitos para muitos. O praticante gênio solitário valida 30 padrões e nunca os publica — <strong>a organização paga o custo de cada outro praticante redescobri-los</strong>. A contribuição é o preço de entrada para que o ciclo se acumule."
    }
  ]
},
"data-types": {
  ...
  questions: [
    {
      prompt: "Um praticante extrai quatro semanas de leituras reais de latência P95 do Azure Monitor para estabelecer a linha de base de um processo. Que tipo de dado é esse?",
    ...
    {
      prompt: "Uma equipe afirma que picos de CPU são a causa-raiz das violações de latência, citando um gráfico em que CPU e latência sobem juntas. Antes de padronizar uma correção, o que um praticante deve fazer?",
...
"control-charts": {
  ...
  questions: [
    ...
    },
    {
      ...
      correctIndex: 1,
      explanation: "Cpk &lt; 1,0 significa que o processo <strong>não é capaz</strong>. Atingir a especificação é sorte, não capacidade. O trabalho do praticante é traduzir o número em &ldquo;problema à frente&rdquo; antes que o próximo aumento de carga cause uma violação."
    },
    {
...
"value": {
  ...
  duration: "30 min",
  executiveSummary: "Valor é tudo aquilo que o cliente está disposto a financiar — declarado nos termos dele, não nos do praticante. Toda atividade em um engajamento é de agregação de valor (VA), não agregação de valor necessária (NNVA) ou puro desperdício (NVA). Definir o valor com precisão é o movimento que separa engajamentos que se justificam na renovação daqueles que produzem movimento sem resultado.",
  whatYouGain: [
    ...
    "A capacidade de justificar as horas do praticante à liderança por resultados, não por esforço",
  ...
  recap: [
    "Valor é definido pelo cliente e moldado por resultado — medido na moeda do cliente (US$ economizados, indisponibilidade evitada, time-to-market, pontos de secure-score), nunca em atividade do praticante",
    ...
    "Relate o valor na EBR/QBR em um slide, nos termos do cliente, sem métricas de atividade do praticante — esse slide vale mais para a renovação do que 30 slides de atividade"
  ],
  questions: [
    {
      prompt: "Quem define o valor em um engajamento Lean?",
      options: [
        "O praticante, com base na excelência técnica.",
    ...
    {
      prompt: "Um praticante classifica os últimos 90 dias como 38% VA, 22% NNVA, 40% NVA. O que isso sinaliza?",
      options: [
        ...
        "O praticante deve solicitar mais orçamento para absorver o overhead.",
    ...
    },
    {
      ...
      options: [
        ...
        "Pelo total de horas do praticante faturadas à conta.",
    ...
    {
      prompt: "O CFO de um cliente usa um painel de gastos no Power BI que o praticante construiu para aprovar US$ 1,2 mi em modernização. Esse painel é VA, NVA ou NNVA?",
      options: [
...
"waste": {
  ...
  questions: [
    ...
    {
      prompt: "Um praticante foi solicitado a encontrar US$ 200 mil/ano em economia. O rightsizing encontrou US$ 90 mil. Uma caminhada estruturada dos 8 Desperdícios encontrou outros US$ 260 mil (assinaturas ociosas, observabilidade redundante, egresso, trabalho repetitivo). Qual é a lição?",
      options: [
        ...
        "O praticante deveria ter feito uma avaliação WAF em vez disso.",
...
"sipoc": {
  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        "Os dólares economizados por hora de praticante.",
  ...
  group: "Mapeamento & Análise de Processos",
  duration: "30 min",
  executiveSummary: "Um gráfico de Pareto classifica categorias em ordem decrescente por impacto (contagem de incidentes, indisponibilidade, US$, RU/s consumidos) e sobrepõe uma linha de percentual acumulado para que os 'poucos vitais' que impulsionam ~80% do impacto fiquem imediatamente visíveis. É a ferramenta de priorização que os praticantes usam para preparação de EBR/QBR, revisões de WAF, otimização de custo e triagem de escalonamento — pondere por impacto de negócio, não por frequência bruta.",
  whatYouGain: [
    "Classificar problemas por impacto de negócio, não por contagem, para que as horas do praticante recaiam sobre os poucos vitais",
  ...
  questions: [
    {
      prompt: "Um cliente tem 4.200 alertas do Azure Advisor. Como você deve construir o Pareto para priorizar o esforço do praticante?",
      options: [
    ...
    },
    {
      ...
      options: [
        ...
        "Medir o total de horas do praticante e comparar com a estimativa original."
      ],
      correctIndex: 1,
  ...
  group: "Ambiente, Fluxo & Padronização",
  duration: "30 min",
  executiveSummary: "O Trabalho Padrão é a melhor forma atualmente conhecida de executar uma tarefa — documentada, ensinada e seguida até que um ciclo PDCA prove uma forma melhor. Sem um padrão, você não consegue dizer se uma mudança melhorou ou apenas variou. Para praticantes, o trabalho padrão é como os ganhos de Kaizen e DMAIC são codificados em módulos de IaC, Policy, runbooks, templates e prompts de agente. O padrão não é estático; é um artefato vivo, com dono, versionado e explicitamente projetado para ser substituído pela sua versão melhor.",
  whatYouGain: [
  ...
  group: "Ambiente, Fluxo & Padronização",
  duration: "30 min",
  executiveSummary: "Takt time é a taxa na qual um processo deve produzir para atender à demanda do cliente: takt = tempo disponível / demanda do cliente. Se a demanda é de 480 requisições por dia de 8 horas, o takt é de 1 minuto por requisição. Tempo de ciclo mais lento que o takt = demanda não atendida e filas crescentes. Tempo de ciclo mais rápido que o takt = desperdício de superprodução, a menos que seja ritmado para baixo. Para praticantes, o takt se aplica à cadência de deploy, resposta a alertas, ritmo de triagem de incidentes, throughput de requisições e taxa de invocação de agentes de IA. Use o takt para dimensionar capacidade, definir SLOs, projetar Trabalho Padrão e detectar superprodução.",
  whatYouGain: [
