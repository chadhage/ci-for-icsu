...
"intro": {
  ...
  group: "Fundamentos",
  duration: "30 min",
  executiveSummary: "A Melhoria Contínua na Microsoft é o tecido conectivo entre a prática voltada ao cliente e os grupos de engenharia que constroem o Azure. Ela se manifesta como a Comunidade de Prática de MC do iCSU, os ciclos de feedback do WAF e do Advisor, os repositórios de playbooks e os rituais entre equipes que acumulam aprendizados por toda a organização. Para um praticante é tanto um recurso (capacitação, playbooks, pares) quanto uma responsabilidade (contribuir com os padrões que você valida, escalar problemas sistêmicos aos grupos de produto). Bem feita, a MC@MS transforma cada engajamento com o cliente tanto em um resultado para aquele cliente quanto em um ativo reutilizável para cada praticante que vier depois.",
  whatYouGain: [
