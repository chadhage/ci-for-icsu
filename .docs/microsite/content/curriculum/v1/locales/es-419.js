/* Smart CI - Contenido de los módulos de entrega de 30 minutos (Español de Latinoamérica / es-419).
...
"intro": {
  ...
  recap: [
    ...
    "La MC no es un proyecto; es un modelo operativo. El éxito es que el cliente ejecute el bucle sin el practicante",
  ...
  questions: [
    ...
    {
      prompt: "¿Cuál es el criterio de salida del practicante para un compromiso de MC exitoso?",
      options: ["El cliente ha completado tres ciclos PDCA.", "Se han implementado todas las recomendaciones de la evaluación inicial.", "El cliente ejecuta el bucle sin el practicante.", "El cliente ha logrado la mayor mejora posible."],
      correctIndex: 2,
      explanation: "El éxito en la MC significa que <strong>el cliente ejecuta la cadencia de forma independiente</strong>. El practicante asesora el bucle; el éxito llega cuando el cliente es dueño de él y el practicante puede retirarse sin que haya regresión."
    },
    {
  ...
  questions: [
    {
      ...
      options: ["Años de experiencia como practicante.", "La profundidad de la capacidad de mejora continua, desde conocer el vocabulario hasta liderar la estrategia de MC de toda la organización.", "Cuántos compromisos con clientes ha cerrado en el último trimestre.", "Su calificación de desempeño interno."],
      correctIndex: 1,
    ...
    {
      prompt: "¿Cómo debería decidir un practicante qué cinturón perseguir a continuación?",
      ...
      correctIndex: 2,
      explanation: "La orientación es <strong>elegir el cinturón que formaliza la próxima brecha</strong>, no el más alto disponible. Un practicante que nunca ha ejecutado un Kaizen real debería buscar el Amarillo, no el Negro. Las credenciales deben ir detrás del trabajo, no al revés."
    },
    {
    ...
    },
    {
      ...
      correctIndex: 1,
      explanation: "Un practicante con cinco cinturones y sin resultados de compromiso validados es <strong>menos eficaz</strong> que uno con un Cinturón Verde y un historial de victorias medibles con clientes. La credencial es evidencia que corrobora, no un sustituto del trabajo."
    },
    {
...
"ms-ci-cop": {
  ...
  group: "Fundamentos",
  duration: "30 min",
  executiveSummary: "La Mejora Continua en Microsoft es el tejido conectivo entre la práctica de los practicantes de cara al cliente y los grupos de ingeniería que construyen Azure. Se manifiesta como la Comunidad de Práctica de MC de CI, los bucles de retroalimentación de WAF y Advisor, los repositorios de manuales de los practicantes y los rituales entre equipos que potencian los aprendizajes en toda la organización. Para un practicante es tanto un recurso (capacitación, manuales, pares) como una responsabilidad (contribuir con los patrones que validas, escalar los problemas sistémicos a los grupos de producto). Bien ejecutada, la MC@MS convierte cada compromiso con un cliente en un resultado para ese cliente y, a la vez, en un activo reutilizable para cada practicante que venga después.",
  whatYouGain: [
    "Comprender cómo la MC@MS agrega los aprendizajes de miles de practicantes y los retroalimenta a los grupos de producto de Azure",
    "Aprender a consumir manuales existentes (WAF, Biblioteca de Manuales, Azure Advisor) en lugar de reinventar patrones de compromiso",
  ...
  explanation: "<p>La MC@MS existe para resolver un problema de escala: un solo practicante es dueño de un puñado de cuentas, pero Microsoft tiene miles de practicantes y decenas de miles de clientes. Sin una práctica de MC que agregue los aprendizajes, cada practicante redescubre los mismos patrones, cada cliente revive los mismos incidentes y los grupos de producto no escuchan la señal con la claridad suficiente para corregir las causas raíz. La MC@MS es el bucle de retroalimentación que convierte las observaciones del campo en mejoras de producto.</p><p>Lo que distingue a las estructuras de la MC@MS es que son <strong>medidas, versionadas, con dueño y reutilizables</strong>. Cada patrón publicado lleva la evidencia de que funcionó. Los manuales evolucionan ciclo tras ciclo; las versiones antiguas se descontinúan, no se eliminan. Cada manual tiene un responsable de mantenimiento designado y una cadencia de actualización. Los patrones se escriben para que el siguiente practicante los aplique, no como anécdotas. Las superficies principales incluyen la Comunidad de Práctica de MC de CI, el marco de evaluación WAF, Azure Advisor y Defender for Cloud como líneas base por cuenta, los manuales versionados de CSE / FastTrack, el plan de estudios de MS Learn y los canales estructurados de escalamiento de campo a PG (bloqueadores de ACR, análisis de firmas de ICM).</p><p>El ritmo de participación en la comunidad es sencillo: consumir los manuales existentes antes de diseñar un nuevo compromiso; ejecutar PDCA sobre trabajo real con clientes; documentar los resultados medidos; llevar los patrones a la llamada mensual de la CoP; dejar que los pares revisen y critiquen; fusionar los patrones validados en bibliotecas compartidas. Los practicantes tanto consumen como contribuyen. Omitir cualquiera de los dos lados rompe el bucle. Cuando la misma causa raíz aparece en 3 o más cuentas, eso es una conversación con el PG, no una solución alternativa de un practicante. Usa los canales de bloqueadores de ACR o de firmas de ICM para escalar las señales sistémicas de modo que ingeniería pueda priorizar las correcciones.</p>",
  ...
  recap: [
    "La MC@MS es el tejido conectivo entre los aprendizajes del campo y las prioridades de los grupos de producto: convierte la observación de un practicante en una mejora para toda la organización",
    "Cada practicante consume los manuales existentes (WAF, Biblioteca de Manuales, guía de Advisor) antes de iniciar un nuevo compromiso",
    "Contribuye con patrones validados de vuelta a la CoP; deja que los pares los revisen; fusiónalos en bibliotecas compartidas; observa cómo se potencian en miles de practicantes",
    "Cuando la misma causa raíz aparece en 3 o más cuentas, escálala como una señal del campo (bloqueador de ACR o firma de ICM) a los grupos de producto, no como una solución alternativa de un practicante",
  ...
  questions: [
    {
      ...
      options: ["Reemplazar los planes de compromiso específicos de cada cliente con una única plantilla corporativa.", "Agregar los aprendizajes de los practicantes y proporcionar un bucle de retroalimentación basado en datos desde el campo hacia los grupos de producto.", "Certificar a los practicantes en los servicios de Azure.", "Proporcionar un sistema centralizado de registro de tiempo para la práctica de los practicantes."],
      correctIndex: 1,
      explanation: "La MC@MS es el tejido conectivo entre el campo y la ingeniería. <strong>Agrega patrones</strong> para que el PG pueda priorizar las correcciones, codifica los patrones de compromiso validados en manuales compartidos y convierte la observación de un practicante en una mejora a nivel de producto."
    },
    {
      prompt: "¿Qué distingue a un manual de la MC@MS de una &ldquo;wiki interna de consejos&rdquo; genérica?",
      options: ["Los manuales solo son accesibles para los practicantes sénior.", "Los manuales se generan automáticamente a partir de la telemetría de Azure.", "Los manuales son medidos, versionados, con un responsable de mantenimiento designado y una cadencia de actualización, y están escritos para ser reutilizables.", "Los manuales son escritos exclusivamente por los grupos de producto."],
      correctIndex: 2,
      explanation: "Cada patrón publicado lleva la <strong>evidencia de que funcionó</strong>, evoluciona ciclo tras ciclo, tiene un dueño designado y está escrito para que el siguiente practicante lo aplique, no como una anécdota."
    },
    {
      prompt: "Un practicante detecta que la misma limitación de producto aparece en tres o más de sus cuentas. ¿Qué recomienda la MC@MS que haga?",
      ...
      correctIndex: 2,
      explanation: "Cuando la misma causa raíz aparece en múltiples cuentas, eso es una <strong>conversación con el PG, no una solución alternativa de un practicante</strong>. Los canales de señal de campo a PG (rastreador de bloqueadores de ACR, análisis de firmas de ICM) existen para convertir la evidencia agregada en MC a nivel de producto."
    },
    {
    ...
    },
    {
      ...
      options: ["Un practicante que escala cada problema directamente al PG sin intentar resolverlo primero.", "Un practicante que solo consume manuales pero nunca contribuye de vuelta.", "Un practicante que valida muchos patrones en sus cuentas pero nunca los publica, obligando a todos los demás practicantes a redescubrir las mismas lecciones.", "Un practicante que trabaja sin un gerente o un revisor par."],
      correctIndex: 2,
      explanation: "La MC@MS es una práctica de muchos a muchos. El practicante genio solitario valida 30 patrones y nunca los publica: <strong>la organización paga el costo de que todos los demás practicantes los redescubran</strong>. La contribución es la cuota de entrada para que el bucle se potencie."
    }
  ]
},
"data-types": {
  ...
  group: "Fundamentos",
  duration: "30 min",
  executiveSummary: "La Mejora Continua funciona con datos, pero no todos los datos son del mismo tipo, y usar el tipo equivocado produce decisiones seguras pero erróneas. Este módulo da a los practicantes un vocabulario práctico para cuatro distinciones de datos que aparecen en cada compromiso: empírico vs. teórico (realidad medida vs. expectativa modelada), cualitativo vs. cuantitativo (descriptivo vs. numérico), continuo vs. discreto (medido sobre un continuo vs. contado) y directo vs. circunstancial (evidencia de la cosa misma vs. un sustituto correlacionado). Saber qué tipo de datos tienes te dice qué herramienta estadística es válida, cuán grande debe ser tu muestra y cuánto peso puede soportar un hallazgo. La disciplina central: anclar cada decisión de MC en una medición empírica y directa de la métrica que importa, y tratar los modelos, los sustitutos y el sentimiento como insumos que te señalan hacia ella, no como prueba.",
  whatYouGain: [
  ...
  questions: [
    {
      prompt: "Un practicante extrae cuatro semanas de lecturas reales de latencia P95 de Azure Monitor para establecer la línea base de un proceso. ¿Qué tipo de datos es este?",
    ...
    {
      prompt: "Un equipo afirma que los picos de CPU son la causa raíz de las infracciones de latencia, citando un gráfico donde la CPU y la latencia suben ambas. Antes de estandarizar una corrección, ¿qué debería hacer un practicante?",
...
"process-capability": {
  ...
  questions: [
    ...
    },
    {
      ...
      correctIndex: 1,
      explanation: "Cpk &lt; 1.0 significa que el proceso <strong>no es capaz</strong>. Cumplir la especificación es suerte, no capacidad. El trabajo del practicante es traducir el número en &ldquo;problemas por delante&rdquo; antes de que el siguiente aumento de carga cause un incumplimiento."
    },
    {
...
"value": {
  ...
  duration: "30 min",
  executiveSummary: "El valor es cualquier cosa que el cliente esté dispuesto a financiar, expresado en sus términos, no en los del practicante. Toda actividad de un compromiso es de valor agregado (VA), no-valor-agregado necesario (NNVA), o desperdicio puro (NVA). Definir el valor con precisión es la jugada que separa los compromisos que se justifican a sí mismos en la renovación de aquellos que producen movimiento sin resultado.",
  whatYouGain: [
    ...
    "La capacidad de justificar las horas del practicante ante el liderazgo mediante resultados, no esfuerzo",
  ...
  recap: [
    "El valor lo define el cliente y tiene forma de resultado, medido en la moneda del cliente ($ ahorrados, tiempo de inactividad evitado, time-to-market, puntos de secure-score), nunca en la actividad del practicante",
    ...
    "Reporte el valor en el EBR/QBR en una sola diapositiva, en los términos del cliente, sin métricas de actividad del practicante: esta diapositiva vale más para la renovación que 30 diapositivas de actividad"
  ],
  questions: [
    {
      prompt: "¿Quién define el valor en un compromiso Lean?",
      options: [
        "El practicante, con base en la excelencia técnica.",
    ...
    {
      prompt: "Un practicante clasifica los últimos 90 días como 38% VA, 22% NNVA, 40% NVA. ¿Qué señala esto?",
      options: [
        ...
        "El practicante debería solicitar más presupuesto para absorber la sobrecarga.",
    ...
    },
    {
      ...
      options: [
        ...
        "Por el total de horas del practicante facturadas a la cuenta.",
    ...
    {
      prompt: "El CFO de un cliente usa un tablero de gasto de Power BI que construyó el practicante para aprobar $1.2M en modernización. ¿Es este tablero VA, NVA o NNVA?",
      options: [
...
"copq": {
  ...
  group: "Definición de Valor & Calidad",
  duration: "30 min",
  executiveSummary: "El Costo de la Mala Calidad (COPQ) cuantifica lo que los defectos, el retrabajo, las fugas y la prevención omitida le cuestan al negocio, dividido en cuatro categorías: falla interna, falla externa, evaluación y prevención. Un rango citado con frecuencia ubica el COPQ en organizaciones que no lo miden en aproximadamente 15–40% del gasto total. Para practicantes, calcular el COPQ es una de las formas más efectivas de financiar el trabajo de CI: una vez que el liderazgo ve el costo de la baja calidad, la inversión en prevención es más fácil de justificar.",
  whatYouGain: [
...
"waste": {
  ...
  group: "Definición de Valor & Calidad",
  duration: "30 min",
  executiveSummary: "Los 8 Desperdicios (DOWNTIME—Defectos, Sobreproducción, Espera, Talento no utilizado, Transporte, Inventario, Movimiento, Sobreprocesamiento) son la lista de verificación 360° de Lean para detectar actividad que no agrega valor en cualquier sistema. Para practicantes, los 8 Desperdicios se traducen limpiamente al patrimonio de Azure: RU sobreaprovisionados, VMs ociosas, entornos obsoletos, stacks de observabilidad redundantes, egreso de datos innecesario, ingenieros atrapados en tareas tediosas, ciclos lentos de respuesta a incidentes y compuertas de aprobación redundantes. Usa los 8 Desperdicios como un recorrido estructurado durante optimizaciones de costos, revisiones de confiabilidad y evaluaciones de modernización: cada categoría revela una clase distinta de oportunidad.",
  whatYouGain: [
  ...
  questions: [
    ...
    {
      prompt: "A un practicante se le pidió encontrar $200K/año en ahorros. El rightsizing halló $90K. Un recorrido estructurado de los 8 Desperdicios halló otros $260K (suscripciones ociosas, observabilidad redundante, egreso, tareas tediosas). ¿Cuál es la lección?",
      options: [
        ...
        "El practicante debería haber hecho una evaluación WAF en su lugar.",
...
"sipoc": {
  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        "Los dólares ahorrados por hora de practicante.",
...
"pareto-chart": {
  ...
  group: "Mapeo & Análisis de Procesos",
  duration: "30 min",
  executiveSummary: "Un diagrama de Pareto ordena las categorías en orden descendente por impacto (cantidad de incidentes, tiempo de inactividad, $, RU/s consumidos) y superpone una línea de porcentaje acumulado para que los 'pocos vitales' que generan ~80% del impacto sean visibles de inmediato. Es la herramienta de priorización que los practicantes usan para preparar EBR/QBR, revisiones de WAF, optimización de costos y triaje de escalamientos: pondera por impacto al negocio, no por frecuencia bruta.",
  whatYouGain: [
    "Ordenar problemas por impacto al negocio, no por cantidad, para que las horas del practicante caigan en los pocos vitales",
  ...
  questions: [
    {
      prompt: "Un cliente tiene 4,200 alertas de Azure Advisor. ¿Cómo deberías construir el Pareto para priorizar el esfuerzo del practicante?",
      options: [
    ...
    },
    {
      ...
      options: [
        ...
        "Medir el total de horas del practicante y compararlo con el estimado original."
      ],
      correctIndex: 1,
...
"gemba": {
  ...
  group: "Lugar de Trabajo, Flujo & Estandarización",
  duration: "30 min",
  executiveSummary: "Gemba significa 'el lugar real'—ir adonde ocurre el trabajo, observarlo directamente y hacer preguntas respetuosas en lugar de apoyarse en reportes, tableros o rumores. El gemba revela la fricción silenciosa y las soluciones improvisadas que las métricas promedian y ocultan. Para practicantes, las caminatas gemba anclan las fases de Medir y Analizar de DMAIC, preparan el trabajo previo de Kaizen y validan si las narrativas del equipo coinciden con la realidad observada. Una observación de 5 minutos a menudo supera una auditoría de 50 páginas.",
  whatYouGain: [
    ...
    "Construye credibilidad del practicante con los ingenieros del cliente al ver su realidad de primera mano, sin apoyarte en resúmenes",
