...
- Apply Andon mechanisms in engineering: automated rollout gates, canary auto-pause, error-budget alerts, and stop-ship authority
...
- Andon in engineering: canary auto-pause, health-gated rollouts, automated rollback, error-budget alerts, and explicit stop-ship authority
...
### 5. What is a good digital equivalent of an Andon cord in a deployment pipeline?
