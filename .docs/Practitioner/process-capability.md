...
Cpk < 1.0 means the process is **not capable**. Hitting the spec is luck, not capability. The practitioner’s job is to translate the number into “trouble ahead” before the next load increase causes a breach.
