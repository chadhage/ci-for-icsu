...
- Use the model to diagnose which part of a system is weak and aim CI effort where it is missing
...
### 5. A team has adopted Kanban and automated quality gates but improvements aren't sticking, and there is no standardized work. What does the House of Lean suggest?
